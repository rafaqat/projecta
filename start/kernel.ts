 ...
 */
server.use([
  () => import('#middleware/share_route_middleware'),
...
router.use([
  ...
  () => import('#middleware/session_lifecycle_middleware'),
  () => import('#middleware/resource_guard_middleware'),
  () => import('#middleware/actor_middleware'),
